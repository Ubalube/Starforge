package com.ubalube.starforge.common.tileentity;
...
public class TileEntityAssembly extends TileEntity implements ITickable, IInventory
{
	...
	{
		return this.hasCustomName() ? this.customName : "container.assembly";
	}
	...
	private boolean canSmelt() 
	{
		...
		{
			ItemStack result = AssemblyRecipes.getInstance().getHarvestorResult((ItemStack)this.inventory.get(0), (ItemStack)this.inventory.get(1));	
	...
	public void smeltItem() 
	{
		if(this.canSmelt()) 
		{
			...
			ItemStack result = AssemblyRecipes.getInstance().getHarvestorResult(input1, input2);
			ItemStack output = (ItemStack)this.inventory.get(3);
